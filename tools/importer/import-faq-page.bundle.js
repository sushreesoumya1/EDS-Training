  ...
  function parse(element, { document: document2 }) {
    ...
    if (cmpItems.length) {
      ...
      cmpItems.forEach((item) => {
        ...
        const title = titleEl ? titleEl.textContent.trim() : item.querySelector(".cmp-accordion__button") ? item.querySelector(".cmp-accordion__button").textContent.trim() : "";
        const panel = item.querySelector(".cmp-accordion__panel");
        const contentCell = panel ? Array.from(panel.childNodes) : "";
        cells2.push([title, contentCell]);
      });
      const block2 = WebImporter.Blocks.createBlock(document2, { name: "accordion-faq", cells: cells2 });
