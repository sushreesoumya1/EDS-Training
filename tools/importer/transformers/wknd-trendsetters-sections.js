 ...
 * Selectors come directly from tools/importer/page-templates.json (DOM-verified
 * during page analysis). Follows the canonical both-hook / marker / reverse-iteration
 * pattern so it survives parsers replacing section elements between the two hooks.
 */
